...
class SbSessionCompatibility:
    ...
    def createSbItem(self, item_json):
        ...
        """
        return _sb.create_item(item_json)
    ...
    def updateSbItem(self, item_json):
        ...
        """
        return _sb.update_item(item_json)
    ...
    def deleteSbItem(self, item_json):
        ...
        :return
        """
        return _sb.delete_item(item_json)
    ...
    def undeleteSbItem(self, item_id):
        ...
        """
        return _sb.undelete_item(item_id)
    ...
    def deleteSbItems(self, item_ids):
        ...
        """
        return _sb.delete_items(item_ids)
    ...
    def moveSbItem(self, item_id, parent_id):
        ...
        :return
        """
        return _sb.move_item(item_id, parent_id)
    ...
    def moveSbItems(self, item_ids, parent_id):
        ...
        """
        return _sb.move_items(item_ids, parent_id)
    ...
    def uploadFileToItem(self, item, filename):
        ...
        :return
        """
        return _sb.upload_file_to_item(item, filename)
    ...
    def uploadFileAndCreateItem(self, parent_id, filename):
        ...
        """
        return _sb.upload_file_and_create_item(parent_id, filename)
